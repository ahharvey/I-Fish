...
RSpec.describe Charts::CatchCompositionsController, type: :controller do
  ...
  let!(:unloading_catch1) { create :unloading_catch, quantity: 10, unloading: unloading1, fish: fish1 }
  let!(:unloading_catch2) { create :unloading_catch, quantity: 10, unloading: unloading1, fish: fish2 }
  let!(:unloading_catch3) { create :unloading_catch, quantity: 20, unloading: unloading2, fish: fish2 }
