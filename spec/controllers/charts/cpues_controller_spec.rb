...
RSpec.describe Charts::CpuesController, type: :controller do


  let(:user)      { create :user }
  let(:admin)     { create :admin }
  let(:company)   { create :company }
  let(:vessel)    { create :vessel, company: company, tonnage: 2 }
  ...
  let!(:unloading_catch1) { create :unloading_catch, quantity: 12, unloading: unloading1, fish: fish1 }
