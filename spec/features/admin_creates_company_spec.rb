...
RSpec.describe "Staff Creates Company" do
  ...
  describe "with signed in staff" do
    ...
    it "creates with valid data" do
      ...
      expect(page).to have_link 'NEW', href: new_company_path
      click_link 'NEW'
      ...
      expect(page).to have_field "Abbreviation"
      expect(page).to have_field "Shark policy"
      expect(page).to have_field "IUU list"
      expect(page).to have_field "Code of conduct"
      expect(page).to have_field "AP2HI member"
      expect(page).to have_field "Avatar"

      expect(page).to have_field "Processing"
      expect(page).to have_field "Harvest"

      fill_in 'Name',  with: 'Company Name ZZZ'
      fill_in 'Abbreviation',  with: 'CNZ'
      check 'Processing'
      check 'Harvest'
      check 'AP2HI member'
      ...
      save_and_open_page
      expect(page).to have_content 'Company Name ZZZ'
      expect(page).to have_content 'CNZ'
      expect(page).to have_content 'Processing Yes'
      expect(page).to have_content 'Harvest Yes'
      expect(page).to have_content 'AP2HI member Yes'
